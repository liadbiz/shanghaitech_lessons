...
def svm_loss_vectorized(W, X, y, reg):
  ...
  # loss.                                                                     #
  #############################################################################
  margin_ = scores - correct_class_scores[...,np.newaxis] + 1
  pos_margin_mask = (margin_ > 0).astype(float)
  margin_sum = pos_margin_mask.sum(1) - 1
  pos_margin_mask[range(pos_margin_mask.shape[0]), y] = - margin_sum
